  ...
  return (
    <div className="section-pad container-site prose max-w-3xl py-14">
      ...
      <p className="mt-4 text-muted">
        ...
        message content) solely to respond to property and agency requests. We do not sell personal
        data. Contact the office to request access or deletion of your information.
      </p>
    </div>
  );
}
