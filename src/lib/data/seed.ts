...
export const lifestyles = [
  {
    slug: "houses",
    title: "Houses",
    description: "Well-maintained family homes with lasting value.",
    image: img.house1,
    type: "HOUSE" as const,
  },
  {
    slug: "apartments",
    title: "Apartments",
    description: "Secure, well-managed lock-up-and-go living.",
    image: img.apartment,
  ...
  },
  {
    slug: "farms",
    title: "Farms",
    description: "Smallholdings and productive rural assets.",
    image: img.farm,
    type: "FARM" as const,
  },
  {
    slug: "developments",
    title: "Developments",
    description: "Projects presented with clarity and care.",
    image: img.house3,
